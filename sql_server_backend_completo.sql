-- ======================================================
-- BASE DE DATOS: ProyectoDegradacionDB
...
IF DB_ID('ProyectoDegradacionDB') IS NOT NULL
BEGIN
    ALTER DATABASE ProyectoDegradacionDB SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE ProyectoDegradacionDB;
END
GO

CREATE DATABASE ProyectoDegradacionDB;
GO

USE ProyectoDegradacionDB;
GO
...
CREATE INDEX IX_Equipos_DepartamentoId ON Equipos(DepartamentoId);
GO
...
INSERT INTO Usuarios (Nombre, Correo, Clave, Rol, Activo, FechaCreacion)
VALUES
...
INSERT INTO Departamentos (Nombre, PresupuestoAsignado)
VALUES
